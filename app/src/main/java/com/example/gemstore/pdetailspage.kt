...
class pdetailspage : Fragment() {
    ...
    private lateinit var imagee : String
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_pdetailspage, container, false)
        imageView = view.findViewById(R.id.image12345)
        textView1 = view.findViewById(R.id.name12345)
        textView2 = view.findViewById(R.id.description12345)
        textView3 = view.findViewById(R.id.savings12345)
        textView4 = view.findViewById(R.id.rating12345)
        textView5 = view.findViewById(R.id.ratingg12345)
        textView6 = view.findViewById(R.id.mrp12345)
        textView7 = view.findViewById(R.id.price12345)
        textView8 = view.findViewById(R.id.company12345)
        cartbtn = view.findViewById(R.id.addtocartbtn3)
        ...
        if (!pid.isNullOrEmpty()) {
            url = "https://www.pradeepk-p.online/mencatapi.php?pid=$pid"
                    ...
                    Response.Listener { response ->
                        try {
                            ...
                            if (jsonArray.length() > 0) {
                              ...
                              val imageURL = "https://pradeepk-p.online/" + jsonObject.getString("image")
                                ...
                                imagee = jsonObject.getString("image")
